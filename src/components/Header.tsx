...
export default function Header() {
  ...
  return (
    ...
    >
      <nav suppressHydrationWarning className="container mx-auto flex max-w-7xl items-center justify-between p-4 bg-background/80 backdrop-blur-sm rounded-b-lg shadow-md">
        <Link href="#home" className="flex items-center group" suppressHydrationWarning>
        ...
        <div suppressHydrationWarning className="hidden md:flex items-center space-x-2">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
        ...
        <div suppressHydrationWarning className="md:hidden flex items-center gap-2">
           <ThemeToggle />
           <Sheet>
              ...
              <SheetContent side="right">
                <div suppressHydrationWarning className="flex flex-col space-y-4 p-4">
                  {navLinks.map((link) => (
