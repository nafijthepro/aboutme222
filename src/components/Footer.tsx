...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      name: 'Instagram',
      icon: Instagram,
      href: 'https://instagram.com/nafijrahaman.me',
    },
    {
      name: 'Twitter',
      icon: Twitter,
      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="flex flex-col items-center justify-center p-4 bg-background/80 backdrop-blur-sm rounded-t-lg shadow-md">
          ...
          <p className="mt-4 text-xs text-foreground/50 flex items-center hover:text-foreground/80 transition-colors duration-300 cursor-pointer">
            © {new Date().getFullYear()} Nafij Rahaman (Nafijur Rahaman)
          ...
          <p className="mt-1 text-[10px] text-foreground/30 font-mono tracking-wider">
            Also known online as Nafij Pro, NafijThePro
          </p>
        </div>
      </div>
    </footer>
