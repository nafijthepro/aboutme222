...
const cardData: BentoCardProps[] = [
  {
    color: "#060010",
    title: "Solo",
    description: "A self-driven developer, always exploring new technologies.",
    label: "Developer",
  },
  {
    color: "#060010",
    title: "Learning",
    description: "Continuously learning and adapting to the latest trends.",
    label: "Enthusiast",
  },
  {
    color: "#060010",
    title: "Student",
    description: "Currently pursuing a Diploma in Engineering.",
    label: "Education",
  },
];
    ...
    <>
      ...
      {enableSpotlight && (
        <GlobalSpotlight
          ...
          enabled={enableSpotlight && !shouldDisableAnimations}
        ...
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
              enableBorderGlow && !shouldDisableAnimations ? "card--border-glow" : ""
            }`;
